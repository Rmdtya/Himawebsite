  ...
  <div class="sidebar close">
    ...
    <ul class="nav-links">
      ...
      <li>
        ...
        <ul class="sub-menu">
          <li><a class="link_name" href="#">Table</a></li>
          <li><a href="tabel/tbl_user.php">User Account</a></li>
          <li><a href="tabel/tbl_inventory.php">Inventory</a></li>
          <li><a href="tabel/tbl_peminjaman.php">Peminjaman</a></li>
          <li><a href="tabel/tbl_pemilih.php">List Pemilih</a></li>
          <li><a href="tabel/tbl_pemilu.php">Pemilu</a></li>
          <li><a href="tabel/tbl_informasi.php">Informasi</a></li>
        </ul>
      </li>
      <li>
        <div class="iocn-link">
