	...
	<div class="table-responsive">
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h2>Manage <b>Inventory Controll</b></h2>
					</div>
					<div class="col-sm-6">
...
<div id="addEmployeeModal" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
          ...
          <div class="form-group">
						<td> <input type="radio" name="filter" value="app"> Elektronik <input type="radio" name="filter" value="app"> Alat-lain <input type="radio" name="filter" value="web"> Lain-lain</td>
					</div>
				</div>
